    ...
    <div class="row">
        ...
        <div id="content-wrapper" class="left-column col-xs-12 col-sm-12 col-md-12">
            <section id="main">
                ...
                <h1>List of products by brand manufacturer</h1>

                <p class="brand-description">
                    <span style="font-size:10pt;font-family:Arial;font-style:normal;">{{ $brand->description }}</span>
                                    ...
                                    <div class="pull-right ">
                                        ...
                                        <div class="pull-left products-sort-order dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="{{ route('product.productByBrand', $brand->id) }}"
                                                    class="select-list ">
                                                    Relevance
                                                </a>
                                                <a href="{{ route('product.productByBrand', $brand->id).'?sort=nameAsc' }}"
                                                    class="select-list ">
                                                    Name, A to Z
                                                </a>
                                                <a href="{{ route('product.productByBrand', $brand->id).'?sort=nameDesc' }}"
                                                    class="select-list ">
                                                    Name, Z to A
                                                </a>
                                                <a href="{{ route('product.productByBrand', $brand->id).'?sort=priceAsc' }}"
                                                    class="select-list ">
                                                    Price, low to high
                                                </a>
                                                <a href="{{ route('product.productByBrand', $brand->id).'?sort=priceDesc' }}"
                                                    class="select-list ">
                                                    Price, high to low
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <ul class="page-list clearfix text-sm-center">
                                            ...
                                            @for($i = 1; $i <= $products->lastPage(); $i++)
                                                <li class="current">
                                                    <a
                                                        href="{{ route('product.productByBrand', [$brand->id, $brand->name]) }}?page={{ $i }}">{{
                                                        $i }}</a>
                                                </li>
                                                @endfor
                                                ...
                                                <li>
                                                    <a rel="next"
                                                        href="{{ route('product.productByBrand', [$brand->id, $brand->name]) }}?page={{ $products->currentPage()+1 }}"
                                                        class="next">
                                                        Next
