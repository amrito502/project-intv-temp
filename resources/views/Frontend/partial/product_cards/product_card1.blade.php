...
<div class="item-inner col-lg-4 col-md-6 col-sm-6 col-xs-12 last-item-of-tablet-line last-item-of-mobile-line">
    <div class="item">
            ...
            <div class="laberProduct-container">
                <div class="laberProduct-image">
                    ...
                    <a href="{{ route('product.singles', [$product->slug]) }}" {{
                        Str::limit($product->name, 30) }}" class="thumbnail product-thumbnail">
                    ...
                    <div class="laberActions">
                        <div class="laberActions-i">
                            <div class="laberActions-top">
                                ...
                                <div class="laberItem">
                                    {{-- <a href="javascript:void(0)" class="button-action js-compare js-compare-add"
                                        --}} {{-- data-id-product="1" data-url-product="#" --}} {{--
                                        data-name-product="Hummingbird printed t-shirt" --}} {{--
                                        data-image-product="http://laberpresta.com/v17/laber_supershop_v17/28-small_default/hummingbird-printed-t-shirt.jpg"
                                        --}} {{-- data-url="#" title="Add to compare">--}}
                                    ...
                                    <a href="javascript:void(0)" class="button-action js-compare js-compare-add" data-id-product="1" data-url-product="#" data-name-product="{{ $product->name }}" data-image-product="{{ asset($product->images->first()->images) }}" data-url="#" title="Add to compare">
                                        <i class="addCompare fa fa-toggle-on"></i>
                                        <i class="removeCompare fa fa-trash-o"></i><span>Add to compare</span>
                                    </a>
