    ...
    <div class="tile">
        <div class="tile-body">
            <div class="container mb-3">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{ route('module.index') }}" class="btn btn-info float-left">
                            <i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back
                        </a>
                        <h3 class="text-center text-uppercase">Create Module</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="order_no" id="order" type="number" step="any">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input class="form-check-input" name="software_admin_only" type="checkbox" id="software_admin_only">
                            <label class="form-check-label" for="software_admin_only">
                              Software Admin Only
                            </label>
                          </div>
                    </div>
