                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="hidden" value="{{ $data->materialrequisition->unit->id }}" id="unit_id"
                                readonly>
                            <input type="text" class="form-control"
                                value="{{ $data->materialrequisition?->unit?->name }}" readonly>
                                    ...
                                    <tr id="itemRow_{{ $item->id + 999 }}">
                                        ...
                                        <td>
                                            <input style="text-align: right;"
                                                ...
                                                onkeyup="row_sum()" required readonly>
                                        </td>
                                        <td align="center">
                                            <input style="text-align: right;"
                                                class="form-control approved_amount approved_amount_{{ $item->id + 999 }}"
                                                type="number" step="any" name="approved_amount[{{ $item->id }}]"
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th align="center" class="py-2 py-1">
                                            ...
                                            <input class="total_approved_amount form-control text-right" type="number"
