                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div style="margin-top: 29px;border-top:1px solid black;border-bottom:1px solid black;">
                            <p style="text-align: center;">Daily Consumption. From {{ date('d-m-Y', strtotime(request()->start_date)) }} to {{ date('d-m-Y', strtotime(request()->end_date)) }}.</p>
                        </div>

                        @include('dashboard.reports.partials.daily_consumption.local_issue_table')
