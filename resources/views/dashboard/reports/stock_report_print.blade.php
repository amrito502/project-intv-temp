                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div style="margin-top: 29px;border-top:1px solid black;border-bottom:1px solid black;">
                            <p style="text-align: center;">Stock Report. From {{ date('d-m-Y', strtotime(request()->start_date)) }} to {{ date('d-m-Y', strtotime(request()->end_date)) }}. Project: @if (request()->project == 999999)
                                Central Stock
                            @else
