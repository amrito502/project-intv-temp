    ...
    <div class="tile-body">
        <div class="">
            <div class="row">
                ...
                <div class="col-md-8">
                    <h2 class="h2 text-center text-uppercase">Daily Consumption List</h2>
                </div>
                @can('create daily use')
                <div class="col-md-2 text-right">
                    <a href="{{ route('dailyuses.create') }}" class="btn btn-info"><i class="fa fa-plus"
                            aria-hidden="true"></i>
                        Create</a>
                </div>
                @endcan
...
<script>
    ...
    function deleteRow(id) {
        ...
        if(c) {
            axios.delete(route('dailyuses.destroy', id))
    ...
    function redirectProjectFilter(){
        ...
        if(projectId){
            window.location.href = route('dailyuses.index') + "?project_id=" + projectId;
        }else{
            window.location.href = route('dailyuses.index');
        }
    }
