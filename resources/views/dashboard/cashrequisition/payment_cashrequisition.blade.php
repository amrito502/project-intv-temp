...
<form action="{{ route('cashrequisition.payment') }}" method="POST">
    @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="select2" id="tower_id">
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="serial" value="{{ $data->serial }}"
    ...
    function addDataToTable(data){
        ...
        let tr = `
            <tr>
                <td>
                    ${data.project.text}
                    <input type="hidden" name="projectId[]" value="${data.project.id}"></input>
                </td>
                <td>
                    ${data.unit.text}
                    <input type="hidden" name="unitId[]" value="${data.unit.id}"></input>
                </td>
                <td>
                    ${data.tower.text}
                    <input type="hidden" name="towerId[]" value="${data.tower.id}"></input>
                </td>
                <td>
                    ${data.budgetHead.text}
                    <input type="hidden" name="budgetheadId[]" value="${data.budgetHead.id}"></input>
                </td>
                <td>
                    ${data.paymentAmount}
                    <input type="hidden" name="paymentAmount[]" value="${data.paymentAmount}"></input>
                </td>
                <td>
