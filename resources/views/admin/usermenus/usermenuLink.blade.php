                        ...
                        <tbody id="tbody">
                        	...
                        	<tr>
                                ...
                                <td class="text-nowrap">
                                    <a href="{{ route('userMenu.ActionLinkEdit',[$menuId, $menu->id]) }}" data-toggle="tooltip" data-original-title="Edit" data-id="{{ $menu->id }}"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
