        ...
        <div class="card" style="margin-bottom: 200px;">
            ...
            <div class="card-body">
                ...
                <div id="addNewMenu" class="">
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" action="{{ route('cashPurchase.save') }}" method="POST"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div
                                                class="form-group {{ $errors->has('cash_serial') ? ' has-danger' : '' }}">
                                                <input type="text" class="form-control form-control-danger"
                                                    name="cash_serial" value="{{ $serialNo }}" required readonly />
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div
                                                ...
                                                <input type="text" class="form-control form-control-danger"
                                                    name="vouchar_no" value="{{ old('vouchar_no') }}" required>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="voucher_date" value="{{ old('voucher_date') }}" readonly>
                                        ...
                                        <div class="col-md-1">
                                            <button type="submit" style="margin-top: 18px;" class="btn btn-outline-info btn-lg waves-effect">
                                                ...
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width:200px;" class="text-right">Rate
                                                            </th>
                                                            <th style="width:200px;" class="text-right">Amount
                                                            </th>
                                                    ...
                                                    <tbody id="tbody">
                                                        <tr>
                                                            <td>
                                                                <select
                                                                    class="inputMobileWidth form-control form-control-danger chzn-select"
                                                            ...
                                                            <td>
                                                                <input style="text-align: right;"
                                                                    class="inputMobileWidth qty qty_1 form-control"
                                                                    type="number" name="qty[]"
                                                                    oninput="totalAmount('1')" value="1"
                                                                    required>
                                                            </td>
                                                            <td>
                                                                <input style="text-align: right;" step="any"
                                                                    class="inputMobileWidth rate_1 form-control"
                                                                    type="number" name="rate[]"
                                                                    oninput="totalAmount('1')" value="0.00"
                                                                    required>
                                                            </td>
                                                            <td>
                                                                <input style="text-align: right;"
                                                                    class="inputMobileWidth amount amount_1 form-control"
                                                            ...
                                                            <td>
                                                                <input style="text-align: right;"
                                                                    class="inputMobileWidth cash_rate_1 form-control"
                                                            ...
                                                            <td>
                                                                <input style="text-align: right;"
                                                                    class="inputMobileWidth cash_amount cash_amount_1 form-control"
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input class="total_qty form-control"
                                                                    type="number" name="total_qty" value="1"
                                                                    readonly>
                                                            </td>
                                                            <th>Total Amount</th>
                                                            <td>
                                                                <input class="total_amount form-control"
                                                                    type="number" name="total_amount" value="0"
                                                                    readonly>
                                                            </td>
...
<script type="text/javascript">
    $(".add_item").click(function () {
            ...
            $("#tbody").append('<tr id="itemRow_' + total + '">' +
                ...
                '</select>'+
                '</td>'+
                '<td><input style="text-align: right;" class="form-control qty qty_'+total+'" type="number" name="qty[]" value="1" required oninput="totalAmount('+total+')"></td>'+
                '<td><input style="text-align: right;" class="form-control rate_'+total+'" type="number" step="any" name="rate[]" value="0.00" required oninput="totalAmount('+total+')"></td>'+
                '<td><input style="text-align: right;" class="form-control amount amount_'+total+'" type="number" name="amount[]" value="0" required readonly></td>'+
