        ...
        <div class="card" style="margin-bottom: 200px;">
            ...
            <div class="card-body">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" action="{{ route('memberSale.save') }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    @php
                                    $class = auth::user()->role == 4 ? "col-md-6" : "col-md-3";
                                    @endphp
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group {{ $errors->has('customer') ? ' has-danger' : '' }}">
                                            ...
                                            <select class="form-control select2" name="store" required>
                                                ...
                                                <option value="{{ $store->id }}">{{ $store->name }} ({{ $store->username
                                                    }})</option>
                                                @endforeach
                                            </select>
                                        </div>
                        ...
                        <div class="row d-none" id="saveBtn">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive" style="height: 500px;">
                                    <table id="table" class="table table-bordered table-striped d-none">
                                        <thead>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <select style="width: 300px;"
                                                        class="form-control product_1 form-control-danger select2"
                                                ...
                                                <td>
                                                    <input style="text-align: right;width: 228px;" class="qty qty_1 form-control" type="number"
                                                        name="qty[]" oninput="totalAmount('1')" value="1" required>
                                                </td>

                                                <td>
                                                    <input style="text-align: right;width: 100px;" class="rate_1 form-control" type="number"
                                                        name="rate[]" oninput="totalAmount('1')" required>
                                                </td>

                                                <td>
                                                    <input style="text-align: right;width: 228px;" class="amount amount_1 form-control"
                                                ...
                                                <td>
                                                    <input style="text-align: right;width: 228px;" class="pp pp_1 form-control" type="number"
                                                        name="pp[]" required readonly>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td>
                                                    <input style="text-align: right;" class="total_pp form-control" type="number"
...
<script type="text/javascript">
    $(".add_item").click(function () {
            ...
            $("#tbody").append('<tr id="itemRow_' + total + '">' +
                '<td>'+
                '<select name="product_id[]" class="form-control select2 itemList_'+total+' product_'+total+'" required>'+
                '</select>'+
                '</td>'+
                '<td>'+
                ...
                '</td>'+
                '<td>'+
                    '<input style="text-align: right;" class="form-control pp pp_'+total+'" type="number" name="pp[]" required readonly>'+
            ...
            $('.itemList_'+total).select2({ width: '100%' });
        ...
        function totalVat(i) {
           ...
           $.ajax({
                type: "POST",
                url : "{{ route('getProductPriceMemberSale') }}",
                data : {
                    product_id:product_id,
                    customer_id:$('#customer').val(),
                },
                success: function(response) {
                    var amount = 1 * response.product_price;
                    var current_vat = response.product_info.vat_amount;
                    $('.current_vat_'+i).val(current_vat);
                    $('.rate_'+i).val(response.product_price);
                    $(".amount_" + i).val(amount.toFixed(2));
                    $(".pp_" + i).val(parseFloat(response.product.pp).toFixed(2) * $('.qty_'+i).val());
