                    ...
                    <table id="dataTable" name="dataTable" class="table table-bordered">
                        ...
                        <tbody id="tbody">
                            ...
                            <tr class="text-right">
                                ...
                                @if (in_array(auth()->user()->role, [1, 2, 6, 7]))
                                <td class="text-left">{{ $memberSale->dealer->username }}</td>
                                @endif
                                <td class="text-left">{{ @$memberSale->customer->name }} ({{ @$memberSale->customer->username }})</td>
                                <td class="text-left">{{ $memberSale->invoice_no }}</td>
                                <td class="text-left">{{ date('d-m-Y', strtotime($memberSale->invoice_date)) }}</td>
                                <td class="text-left">
                                    <ul>
                                ...
                                <td>{{ $memberSale->invoiceTotalItemQty() }}</td>
                                <td>{{ $memberSale->invoice_amount }}</td>
                                <td>{{ number_format($memberSale->invoiceTotalPP(), 2, '.', '') }}</td>
