    ...
    <div class="tile-body">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <h2 class="h2 text-center">AD List</h2>
                </div>
                @can('ad create')
                <div class="col-md-2">
                    <a href="{{ route('ad.create') }}" class="btn btn-info"><i class="fa fa-plus"
                            aria-hidden="true"></i>
                        Create New</a>
                </div>
                @endcan
    ...
    <div class="tile-body" style="overflow-y: auto">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <table class="table table-hover table-bordered" id="ad-table">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>AD Image</th>
