                ...
                <div class="col-md-12">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="unverified">
                            <div class="mt-5">
                                @include('admin.mlm.dashboard.layouts.account_approval.unverified')
                            </div>
                        </div>
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="verified">
                            <div class="mt-5">
                                @include('admin.mlm.dashboard.layouts.account_approval.verified')
                            </div>
                        </div>
                    </div>
...
<script>
    function toggleStatus(id){
            axios.post(route('account.approval', {
                id,
            }))
