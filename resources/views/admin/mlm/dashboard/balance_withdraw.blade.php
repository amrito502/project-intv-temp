    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <h4 class="card-title">Wallet Balance: {{ Auth::user()->CashWallet() }} &#2547;</h4>
            </div>
        ...
        <div style="height:450px;">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane container active" id="withdraw">
                    @if (Auth::user()->currentRank() != 'Customer')

                    <form action="{{ route('balanceWithdraw') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="withdraw_type" class="select2" id="withdraw_type" required>
