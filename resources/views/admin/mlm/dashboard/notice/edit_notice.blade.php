...
<div class="card">
    ...
    <form action="{{ route('notice.update', $data->notice) }}" method="POST">
        @csrf
        @method('patch')
        <div class="card-body">
            <div class="row justify-content-center">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="description" id="description" type="text" value="{{ $data->notice->description }}">
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="chosen-select" name="roles[]" id="roles" multiple>
                            ...
                            <option value="{{ $role->id }}"
                                @if (in_array($role->id, $data->notice_roles))
                                selected
                                @endif
                                >{{ $role->name }}</option>
                            @endforeach
