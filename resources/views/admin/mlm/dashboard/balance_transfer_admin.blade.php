...
<form action="{{ route('admin.balance.transfer.post') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="text-center">Balance Transfer (Admin)</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>To</label>
                            <select name="to" id="to" class="select2" onchange="showUserData('to','to-user-info')">
                                <option value="">Select An User</option>
                                @foreach ($data->members as $member)
                                <option value="{{ $member->id }}">{{ $member->username }}</option>
                                @endforeach
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Amount</label>
                            <input type="number" name="transfer_amount" class="form-control" placeholder="Enter Amount">
                        </div>
                    </div>
