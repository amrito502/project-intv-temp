...
<?php
    $purchase_return_date = Date('d-m-Y',strtotime($dealerPurchaseReturn->purchase_return_date));
?>
                ...
                <div id="addNewMenu" class="">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="{{ route('dealerPurchaseReturn.update') }}"
                                method="POST" enctype="multipart/form-data" id="newMenu" name="newMenu">
                                {{ csrf_field() }}

                                <input type="hidden" name="dealerPurchaseReturnId"
                                    value="{{$dealerPurchaseReturn->id}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="text" class="form-control form-control-danger"
                                                            value="{{$dealerPurchaseReturn->purchase_return_serial}}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="dealer" id="dealer" class="chosen-select">
                                                            ...
                                                            <option value="{{ $dealer->id }}"
                                                                @if ($dealer->id == $dealerPurchaseReturn->dealer_id)
                                                                selected
                                                                @endif
                                                                >
                                                ...
                                                @else
                                                <input type="hidden" name="dealer" value="{{ $dealerPurchaseReturn->dealer_id }}">
                                                @endif
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="text" name="remarks" class="form-control"
                                                            value="{{$dealerPurchaseReturn->remarks}}">
                                                    ...
                                                    <div class="form-group">
                                                        <table width="95%"
                                                            ...
                                                            <tbody id="tbody">
                                                                <?php
                                                                        $i = 0;
                                                                        $countItem = count($dealerPurchaseReturnItem);
                                                                        foreach ($dealerPurchaseReturnItem as $item) {
                                                                            $i++;
                                                                    ?>
                                                                <tr id="itemRow_{{$i}}">
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input class="total_qty" type="number"
                                                                            name="total_qty"
                                                                            value="{{$dealerPurchaseReturn->total_qty}}"
                                                                            readonly>
                                                                    </td>
                                                                    <th>Total Amount</th>
                                                                    <td>
                                                                        <input class="total_amount" type="number"
                                                                            name="total_amount"
                                                                            value="{{$dealerPurchaseReturn->total_amount}}"
                                                                            readonly>
                                                                    </td>
