            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="dataTable" class="table table-bordered table-striped"  name="dataTable">
                        ...
                        <tbody id="tbody">
                            @php $sl = 0; @endphp
                            @foreach($dealerPurchaseReturn as $returnPurchase)
                            @php
                                $sl++;
                            ...
                            <tr>
                                ...
                                <td>{{ @$returnPurchase->dealer->name }} ({{ @$returnPurchase->dealer->username }} )</td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTable tbody').on( 'click', 'i.fa-trash', function () {
                ...
                dealerPurchaseReturnId = $(this).parent().data('id');
                var tableRow = this;
                swal({
                    title: "Are you sure?",
                    ...
                    if (isConfirm) {
                       $.ajax({
                            type: "POST",
                           url : "{{ route('dealerPurchaseReturn.destroy') }}",
                            data : {dealerPurchaseReturnId:dealerPurchaseReturnId},
