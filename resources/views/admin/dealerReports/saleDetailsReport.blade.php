...
<div class="row">
    <div class="col-12">
        <div class="card" style="margin-bottom: 50px;">
            ...
            <div class="card-body">
                <form class="form-horizontal" id="searchForm" action="{{ route('dealerSaleDatewise.report') }}"
                    ...
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <br>
                            <button type="submit" name="searched" value="summary"
                            ...
                            <button type="submit" name="searched" value="details"
                                class="btn btn-outline-info btn-lg waves-effect">
                                <span style="font-size: 16px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <span class="shortlink">
                            ...
                            <a href="{{ route('dealerSaleDatewise.report.print').'?'.$paramsEncoded }}"
                                class="btn btn-outline-info btn-lg waves-effect">
                                <span style="font-size: 16px;">
