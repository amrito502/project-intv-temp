    ...
    <table class="table table-bordered table-striped" id="report-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $memberSale->customer->name }} ({{
                    $memberSale->customer->username }})</td>
                <td class="text-center">{{ $memberSale->customer->mobile }}</td>
                <td class="text-center">{{ $item->product->name }} ({{
                    $item->product->deal_code }})</td>
