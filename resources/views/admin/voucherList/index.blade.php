    ...
    <div class="card-body">
        <table id="dataTable" name="productList" class="table table-bordered table-sm">
            ...
            <tbody>
                ...
                if ($voucherList->voucherType != "JV")
                {
                $debitHeadName = $debitHeadName->where($fld_debit,0);
                }

                $debitHeadName = $debitHeadName->first();
                ...
                if ($voucherList->voucherType != "JV")
                {
                    $creditHeadName = $creditHeadName->where($fld_credit,0);
                }

                $creditHeadName = $creditHeadName->first();
                @endphp
                <tr>
                    <td>{{ $sl++ }}</td>
