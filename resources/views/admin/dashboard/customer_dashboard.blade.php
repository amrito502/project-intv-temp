            ...
            <div class="col-md-5">
                ...
                <div class="w-100 text-center">
                    <div class="userImageParent">
                        <img src="{{ auth()->user()->profile_image() }}" class="userImage" alt="">
                    </div>
                </div>
            ...
            <div class="col-md-7">
                ...
                <div class="text-center mt-1">
                    <div class="userRankParent">
                        ...
                        <h2 class="mt-4">{{ Auth::user()->currentRank() }}</h2>
                    </div>
                </div>
                ...
                <table class="middle-table-fz text-dark mt-3" style="width: 93%;margin: 0 auto;">
                    ...
                    <tr>
                        ...
                        <td style="font-size: 16px;" class="text-left">
                            ...
                            $diff = Auth::user()->created_at->diffInDays($now);
                            @endphp

                            {{ Auth::user()->created_at->format('d-m-Y') }} ({{ $diff }} days ago)
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 16px;" class="text-left">
                            ...
                            $rankDate = Carbon::parse(Auth::user()->rank_date);

                            $diff = $rankDate->diffInDays($now);
                            @endphp

                            {{ $rankDate->format('d-m-Y') }} ({{ $diff }} days ago)
                        </td>
                    </tr>
                    ...
                    {{-- <tr>
                        ...
                        <td style="font-size: 16px;" class="text-left">
                            @if (Auth::user()->rank_date)
                            {{ date('d-m-Y', strtotime(Auth::user()->rank_date)) }}
                            @else
                            {{ Auth::user()->created_at->format('d-m-Y') }} ({{ $diff }} days ago)
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 16px;" class="text-left">
                            {{ @Auth::user()->placeMember->username }}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 16px;" class="text-left">
                            {{ Auth::user()->DownLevelMemberAllIdsWithHandCount(1) }} : {{
                            Auth::user()->DownLevelMemberAllIdsWithHandCount(2) }}
                            : {{ Auth::user()->DownLevelMemberAllIdsWithHandCount(3) }}
                        </td>
                    </tr>
                    ...
                    <td style="font-size: 16px;" class="text-left">
                        {{ Auth::user()->downLevelAllReferWhereRankIsMemberPoint(1) }} : {{
                        Auth::user()->downLevelAllReferWhereRankIsMemberPoint(2) }}
                        : {{ Auth::user()->downLevelAllReferWhereRankIsMemberPoint(3) }}
                    </td>
                    </tr>
                ...
                <div class="d-flex" style="justify-content:center;">
                    <div style="width: 95%;margin: 0 auto;">
                        <input id="refUrl" type="text" class="form-control font-weight-normal"
                            value="{{ route('customer.registration', ['reference' => Auth::user()->id]) }}"
                            onclick="copyText()">
                    </div>
                </div>
