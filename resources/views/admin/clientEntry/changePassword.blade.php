    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6"><h4 class="card-title">{{ $title }} Of {{ $client->name }}</h4></div>
                    <div class="col-md-6">
            ...
            <div class="card-body">
                ...
                @endphp
                  ...
                  <div id="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" action="{{ route('clientEntry.updatePassword') }}" method="POST" enctype="multipart/form-data" id="newProduct" name="newProduct">
                            {{ csrf_field() }}
