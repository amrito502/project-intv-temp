...
class JournalEntryController extends Controller
{
    ...
    public function add()
    {
    	...
    	return view('admin.journalEntry.add')->with(compact('title','formLink','buttonName','coas'));
    }
    ...
    public function printJournalVoucher($journalEntryId)
    {
        ...
        $pdf = PDF::loadView('admin.journalEntry.printJournalVoucher',['title'=>$title,'journalEntry'=>$journalEntry,'journalEntries'=>$journalEntries],[]);
