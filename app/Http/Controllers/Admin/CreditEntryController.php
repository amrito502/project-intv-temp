...
class CreditEntryController extends Controller
{
    ...
    public function print(Request $request)
    {
        ...
        $pdf = PDF::loadView('admin.creditEntry.print', ['title' => $title, 'fromDate' => $fromDate, 'toDate' => $toDate, 'print' => $print, 'transactionLists' => $transactionLists], []);
        return $pdf->stream('credit_voucher_' . $fromDate . '_' . $toDate . '.pdf');
    }
    ...
    public function add()
    {
        ...
        $debitCoas = CoaSetup::where(function ($q) {
        ...
        return view('admin.creditEntry.add')->with(compact('title', 'formLink', 'buttonName', 'coas', 'debitCoas', 'voucherNo'));
    }
    ...
    public function printCreditVoucher($creditEntryId)
    {
        ...
        $pdf = PDF::loadView('admin.creditEntry.printCreditVoucher', ['title' => $title, 'creditEntry' => $creditEntry, 'creditEntries' => $creditEntries], []);
        return $pdf->stream('credit_voucher_' . $creditEntry->voucher_no . '.pdf');
    }
