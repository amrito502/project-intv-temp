...
class CashBookController extends Controller
{
    public function index(Request $request)
    {
        ...
        $previousBalance = DB::table('tbl_account_transactions')
            ...
            ->where('coa_head_code', 'like', $coaHeadCode->head_code . "%")
            ->where('approve', 1)
            ->first();
    ...
    public function print(Request $request)
    {
        ...
        $pdf = PDF::loadView('admin.cashBook.print', ['title' => $title, 'fromDate' => $fromDate, 'toDate' => $toDate, 'print' => $print, 'cashBookReports' => $cashBookReports, 'previousBalance' => $previousBalance], []);
