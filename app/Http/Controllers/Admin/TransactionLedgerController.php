...
class TransactionLedgerController extends Controller
{
	public function index(Request $request)
	{
    	...
    	$previousBalance = DB::table('tbl_account_transactions')
    		...
    		->where('coa_head_code', 'like', $transactionLedgerHead . '%')
    		->where('approve',1)
    		->first();
	...
	public function print(Request $request)
	{
        ...
        $pdf = PDF::loadView('admin.transactionLedger.print',['title'=>$title,'fromDate'=>$fromDate,'toDate'=>$toDate,'print'=>$print,'transactionLedgerReports'=>$transactionLedgerReports,'transactionLedgerHeadName'=>$transactionLedgerHeadName,'previousBalance'=>$previousBalance],[]);
