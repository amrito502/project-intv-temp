...
class GeneralLedgerController extends Controller
{
	...
	public function print(Request $request)
	{
        ...
        $pdf = PDF::loadView('admin.generalLedger.print',['title'=>$title,'fromDate'=>$fromDate,'toDate'=>$toDate,'print'=>$print,'generalLedgerReports'=>$generalLedgerReports,'generalLedgerHeadName'=>$generalLedgerHeadName,'previousBalance'=>$previousBalance],[]);
